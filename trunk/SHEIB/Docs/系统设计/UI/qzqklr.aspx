<%@ Page language="c#" Codebehind="qzqklr.aspx.cs" AutoEventWireup="false" Inherits="JITE.jhpt.qzqklr" %>
				...
				<TBODY>
					<tr>
						<td style="PADDING-LEFT: 40px">
							...
							<table cellSpacing="0" cellPadding="0" width="95%" border="0">
								<tr>
									<td align="center"><asp:datagrid id="DgXmlist" runat="server" PageSize="8" width="100%" AllowPaging="True" CellPadding="0"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="操作">
													<HeaderStyle Width="5%"></HeaderStyle>
													<ItemTemplate>
														<asp:HyperLink id=HyperLink1 runat="server" Target=_blank NavigateUrl='<%# "qzqklrDesc.aspx?id="+DataBinder.Eval(Container.DataItem,"id")%>'>录入信息</asp:HyperLink>
													</ItemTemplate>
												</asp:TemplateColumn>
