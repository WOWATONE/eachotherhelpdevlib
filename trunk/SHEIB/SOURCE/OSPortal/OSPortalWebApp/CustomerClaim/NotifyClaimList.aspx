<%@ Page Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true"
    Theme="Aqua" CodeBehind="NotifyClaimList.aspx.cs" Inherits="OSPortalWebApp.CustomerClaim.NotifyClaimList"
    Title="" %>
                ...
                <asp:Panel ID="npSearchDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table style="width: 90%">
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deStartNotifyTime" runat="server">
                                </dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                报案结束日期：
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deEndNotifyTime" runat="server">
                                </dxe:ASPxDateEdit>
                            </td>
                            <td style="text-align: left;">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deStartAccidentTime" runat="server">
                                </dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                报案结束日期：
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deEndAccidentTime" runat="server">
                                </dxe:ASPxDateEdit>
                            </td>
                            <td style="text-align: left;">
                            </td>
                            ...
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="理赔编号" FieldName="NotifyID" VisibleIndex="1">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="保单编号" FieldName="PolicyNo" VisibleIndex="2">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="报案流水号" FieldName="NotifySerialNo" VisibleIndex="3">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="报案时间" FieldName="NotifyTime" VisibleIndex="4">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="出险时间" FieldName="AccidentTime" VisibleIndex="5">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="报案人" FieldName="NotifyPerson" VisibleIndex="6">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="报损金额" FieldName="NotifyLossFee" VisibleIndex="7">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="联系人" FieldName="ContactPerson" VisibleIndex="8">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="报案方式" FieldName="NotifyType" VisibleIndex="9">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="报案号" FieldName="NotifyNo" VisibleIndex="10">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="查勘时间" FieldName="PerambulateTime" VisibleIndex="11">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="结案时间" FieldName="CaseEndTime" VisibleIndex="12">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="最终赔付金额" FieldName="LastPayFee" VisibleIndex="13">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="免赔额" FieldName="AcquitFee" VisibleIndex="14">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="制单人" FieldName="CreatePerson" VisibleIndex="15">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="制单日期" FieldName="CreateDate" VisibleIndex="16">
                                        </dxwgv:GridViewDataTextColumn>
                                    </Columns>
