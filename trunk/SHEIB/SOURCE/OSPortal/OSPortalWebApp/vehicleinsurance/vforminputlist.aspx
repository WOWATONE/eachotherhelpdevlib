<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="vforminputlist.aspx.cs" Inherits="OSPortalWebApp.vehicleinsurance.vforminputlist" %>
    ...
    <script type="text/javascript">
	    ...
	    function menuClick(url) {	        
            ...
            else
            {
                ...
                window.showModalDialog("vforminput.aspx", "", myArguments);
            }
	    }
    </script>
</asp:Content>
