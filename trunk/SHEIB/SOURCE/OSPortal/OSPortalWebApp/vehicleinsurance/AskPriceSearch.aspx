...
<%@ Register src="../Controls/AskPriceSearch.ascx" tagname="AskPriceSearch" tagprefix="uc1" %>
    ...
    <table style="width:100%">
                    <tr>
                        ...
                        <td style="height:40px; width:55%;">
                            <table style="margin:0px; padding:0px; width:100%; border:0px; text-align:right">
				                        <tr>
					                        <td style="width:40%; color:#0E5ED5;">当前位置：询价单检索&nbsp;&nbsp;
                    ...
                    <tr>
                        <td style="width:100%;" colspan="2">                
                            <uc1:AskPriceSearch ID="AskPriceSearch1" runat="server" />
                        </td>
                    </tr>                    
        </table>
