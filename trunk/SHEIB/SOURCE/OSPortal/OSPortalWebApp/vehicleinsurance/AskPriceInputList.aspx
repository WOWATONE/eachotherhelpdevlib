<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="AskPriceInputList.aspx.cs" Inherits="OSPortalWebApp.vehicleinsurance.AskPriceInputList" %>
                    ...
                    <tr>
                        ...
                        <td style="height:40px; width:55%;">
                            <table style="margin:0px; padding:0px; width:100%; border:0px; text-align:left">
				                        <tr>
					                        <td style="width:40%; color:#0E5ED5;">当前位置：询价单录入&nbsp;&nbsp;
