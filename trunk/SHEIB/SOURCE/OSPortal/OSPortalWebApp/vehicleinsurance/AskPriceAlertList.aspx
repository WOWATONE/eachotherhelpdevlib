<%@ Page Title="询价单批改列表" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="AskPriceAlertList.aspx.cs" Inherits="OSPortalWebApp.vehicleinsurance.AskPriceAlertList" %>
                    ...
                    <tr>
                        ...
                        <td style="height:40px; width:55%;">
                            <table style="margin:0px; padding:0px; width:100%; border:0px; text-align:left">
				                        <tr>
					                        <td style="width:40%; color:#0E5ED5;">当前位置：询价单批改&nbsp;
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="PrePolicyNo" Caption="交易号" CellStyle-Wrap="False">                                                                   
