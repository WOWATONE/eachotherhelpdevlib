<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="PolicyInputList.aspx.cs" Inherits="OSPortalWebApp.otherinsurance.PolicyInputList" %>
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="CheckMemo" Caption="审核备注" VisibleIndex="20" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                            </Columns>
                                                        <%-- EndRegion --%>
