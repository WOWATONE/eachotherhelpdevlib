   ...
   with (document) {
   write("<Div id='VicPopCal' style='OVERFLOW:hidden;POSITION:absolute;VISIBILITY:hidden;border:0px ridge;width:200;height:230;top:0;left:0;z-index:100;overflow:hidden'>");
   ...
   write("<B ID=\"CAL_C_BLANK\" style='color:"+gcBG+"; visibility:visible; cursor:hand; font-size:12px' onclick='HiddenDiv();' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcBG'>取消</B>");
   ...
   function fload(textObject)
   {
    if(N)
    {
     var textObj = document.getElementById(textObject.name);
     fPopCalendar(textObj, textObj);
    }
    else
    {
     fPopCalendar(textObject, textObject);
    }
