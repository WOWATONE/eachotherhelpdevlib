<%@ Page Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true"
    Theme="Aqua" CodeBehind="ProductTypeList.aspx.cs" Inherits="OSPortalWebApp.ProductSetup.ProductTypeList"
    Title="" %>
                    ...
                    <PanelCollection>
                        <dxrp:PanelContent ID="PanelContent2" runat="server">
                            <dxcp:ASPxCallbackPanel runat="server" ID="cpSchemaDetail" ClientInstanceName="cpSchemaDetail"
                                ...
                                <ClientSideEvents Init="function(s, e) { cpSchemaDetail_Init(); }" EndCallback="cpSchemaDetail_OnEndCallback">
                                </ClientSideEvents>
                                <PanelCollection>
                                            ...
                                            <tr>
                                                <td>
                                                    <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                                        ...
                                                        <Columns>
                                                            <dxwgv:GridViewDataTextColumn Caption="项目编号" FieldName="ProdNo" VisibleIndex="0">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn Caption="项目名称" FieldName="ProdName" VisibleIndex="1">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn Caption="保费费率" FieldName="PremiumRate" VisibleIndex="2">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn Caption="是否主险" FieldName="FlagMain" VisibleIndex="3">
                                                            </dxwgv:GridViewDataTextColumn>
                                                        </Columns>
