<%@ Page Title="经纪费结算选择" Language="C#" Theme="Aqua" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true" CodeBehind="FeeProcessAddSelect.aspx.cs" Inherits="OSPortalWebApp.inoutbalance.FeeProcessAddSelect" %>
                    ...
                    <tr>
                        <td style="width:100%;" colspan="2"> 
                            ...
                            <asp:Panel ID="npSearchDetail" runat="server" CssClass="collapsePanel" Height="0">
                                <table style="width:100%;">
                                                <tr>
                                                    <td style="width:90px;text-align:right; white-space:nowrap;">开票单编号：</td>
                                                    ...
                                                    <td style="width:160px;text-align:right;white-space:nowrap;">保险公司：</td> 
                                                    <td style="width:100px;text-align:left;">                                                        
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="NoticeDate" Caption="开票日期" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                            </Columns>
                                                        <%-- EndRegion --%>
