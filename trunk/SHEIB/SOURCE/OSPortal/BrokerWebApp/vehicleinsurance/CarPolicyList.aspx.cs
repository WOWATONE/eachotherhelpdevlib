...
namespace BrokerWebApp.vehicleinsurance
{
    public partial class CarPolicyList : BasePage
    {
        ...
        private void Initialization()
        {
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.PolicyInfo_AppendList_Search_Group))
            {
                userList = BusinessObjects.BO_P_User.FetchDeptUserList(this.CurrentUser.DeptID);
            }
            else if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.PolicyInfo_AppendList_Search_All))
            {
        ...
        {
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.PolicyInfo_AppendList_Search_Personal))
            {
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.PolicyInfo_AppendList_Search_All))
            {
