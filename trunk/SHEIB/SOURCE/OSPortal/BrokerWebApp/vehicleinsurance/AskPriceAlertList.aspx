<%@ Page Title="询价单批改列表" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="AskPriceAlertList.aspx.cs" Inherits="BrokerWebApp.vehicleinsurance.AskPriceAlertList" %>
                                           ...
                                           <tr>
                                                <td>
                                                    ...
                                                    <asp:ObjectDataSource ID="ds_gridAuditSearchResult" runat="server" 
                                                        ...
                                                        >
                                                        <SelectParameters> 
                                                             <asp:Parameter Name="sWhere" Type="String" Direction="Input" DefaultValue=" and ISNULL(A1.PolicyStatus,'0') = '2'" />
                                                        </SelectParameters>
                                                    </asp:ObjectDataSource>                                                   
                                                </td>
                                            </tr>
