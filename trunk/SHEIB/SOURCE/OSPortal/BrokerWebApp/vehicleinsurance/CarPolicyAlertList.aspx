...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	function getTheAuditSelectedRowsValues(selectedValues) {
	    if (selectedValues.length == 0) {
	        ...
	        var querystring;
	        querystring = "CarPolicyAlert.aspx?pagemode=input&pid=" + selectedValues;
                ...
                <asp:Panel ID="npSearchDetail" runat="server" CssClass="collapsePanel" Height="0">
                     ...
                     <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">保单编号：
                            </td>
                            <td style="text-align: left;">
                                           ...
                                           <tr>
                                                <td>
                                                    ...
                                                    <asp:ObjectDataSource ID="ds_gridSearchResult" runat="server" 
                                                        ...
                                                        >
                                                        <SelectParameters> 
                                                             <asp:Parameter Name="sWhere" Type="String" Direction="Input" DefaultValue=" and ISNULL(B.PolicyStatus,'0') = '0' and ISNULL(B.PrevPolicyID,'') != '' AND ISNULL(B.PolicyType,'0') ='1' " />
                                                        </SelectParameters>
                                           ...
                                           <tr>
                                                <td>
                                                    <dxwgv:ASPxGridView ID="gridAuditSearchResult" ClientInstanceName="gridAuditSearchResult" runat="server"
                                                        DataSourceID="ds_gridAuditSearchResult"
                                                        KeyFieldName="PolicyID" AutoGenerateColumns="False" Settings-ShowFooter="true"
                                                        Width="100%" SettingsPager-AlwaysShowPager="true" 
                                                        ...
                                                        <Settings ShowGroupPanel="true" ShowFooter="True" ShowGroupFooter="VisibleAlways" />
                                                        <SettingsBehavior AllowDragDrop="true" AllowGroup="true" AutoExpandAllGroups="true" />
                                                        <TotalSummary>
                                                            <dxwgv:ASPxSummaryItem FieldName="PolicyID" SummaryType="Count" DisplayFormat="#" /> 
                                                            <dxwgv:ASPxSummaryItem FieldName="CiPremium" SummaryType="Sum" DisplayFormat="c" />
                                                            <dxwgv:ASPxSummaryItem FieldName="CiProcess" SummaryType="Sum" DisplayFormat="c" />
                                                    ...
                                                    <asp:ObjectDataSource ID="ds_gridAuditSearchResult" runat="server" 
                                                        SelectMethod="FetchPolicyList"
                                                        TypeName="BusinessObjects.Policy.BO_Policy" 
                                                        EnablePaging="false"  CacheDuration="1"                                                                                                                                                      
                                                        >
                                                        <SelectParameters> 
                                                             <asp:Parameter Name="sWhere" Type="String" Direction="Input" DefaultValue=" and ISNULL(B.PolicyStatus,'0') = '2' and ISNULL(B.PrevPolicyID,'') = '' AND ISNULL(B.PolicyType,'0') ='1' " />
                                                        </SelectParameters>
                                                    </asp:ObjectDataSource>                                                   
                                                </td>
                                            </tr>
