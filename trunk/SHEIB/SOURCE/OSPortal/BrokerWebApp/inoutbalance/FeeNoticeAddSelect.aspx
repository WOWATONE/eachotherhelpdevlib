<%@ Page Title="客户收费保单选择" Language="C#" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="FeeNoticeAddSelect.aspx.cs" Inherits="BrokerWebApp.inoutbalance.FeeNoticeAddSelect" %>
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataDateColumn FieldName="PayDate" Caption="应收日期" CellStyle-Wrap="False" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd">                                                                   
