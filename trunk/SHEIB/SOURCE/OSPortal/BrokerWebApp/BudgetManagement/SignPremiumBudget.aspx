<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/PopupUploadMaster.Master"
    AutoEventWireup="true" Theme="Aqua" CodeBehind="SignPremiumBudget.aspx.cs" Inherits="BrokerWebApp.BudgetManagement.SignPremiumBudget" %>
                    ...
                    <dxw:ContentControl ID="ContentControl1" runat="server">
                        ...
                        <table style="width: 80%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <dxe:ASPxTextBox ID="dxetxtPremiumBudget" ClientInstanceName="dxetxtPremiumBudget"
                                ...
                                <td style="text-align: left;">
                                    <dxe:ASPxTextBox ID="dextxtProcessBudget" ClientInstanceName="dextxtProcessBudget"
                                        runat="server" Width="160px">
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithText" SetFocusOnError="True">
                                            <RequiredField ErrorText="必填项" IsRequired="True" />
                                        </ValidationSettings>
            ...
            <tr>
                ...
                <td style="width: 50px; text-align: left;">
                    <dxe:ASPxButton runat="server" ID="dxebtnBottomSave" ClientInstanceName="dxebtnBottomSave"
                        Text="保存" CausesValidation="true" AutoPostBack="false" OnClick="dxebtnBottomSave_Click">
                    </dxe:ASPxButton>
                </td>
                <td style="width: 50px; text-align: left;">
