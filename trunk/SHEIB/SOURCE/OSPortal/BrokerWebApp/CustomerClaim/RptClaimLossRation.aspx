<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" CodeBehind="RptClaimLossRation.aspx.cs" Inherits="BrokerWebApp.CustomerClaim.RptClaimLossRation" %>
                        ...
                        <tr>
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <%-- BeginRegion Columns --%>
                                    <Columns>                            
                                        <dxwgv:GridViewDataColumn FieldName="RQ" Caption="日期" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="PAS" Caption="赔案数" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="PABL" Caption="占比" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="ClaimFee" Caption="赔付金额OR报损金额" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
