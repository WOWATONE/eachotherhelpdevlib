<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" CodeBehind="RptClaimTimelinessAnalysis.aspx.cs" Inherits="BrokerWebApp.CustomerClaim.RptClaimTimelinessAnalysis" %>
                        ...
                        <tr>
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <%-- BeginRegion Columns --%>
                                    <Columns>                            
                                        <dxwgv:GridViewDataColumn FieldName="Tranche" Caption="结案效率" CellStyle-Wrap="False">
