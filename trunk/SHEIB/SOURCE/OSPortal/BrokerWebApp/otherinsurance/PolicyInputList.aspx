                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;">
                                            <dxe:ASPxComboBox ID="dxeddlDeptID" ClientInstanceName="dxeddlDeptID" runat="server"
                                                Width="240px" DropDownStyle="DropDownList">
                                                <items>
												</items>
                                        ...
                                        <td style="text-align: left;">
                                            <dxe:ASPxComboBox ID="dxeddlSalesId" ClientInstanceName="dxeddlSalesId" runat="server"
                                                Width="240px" DropDownStyle="DropDownList" OnCallback="dxeddlSalesIdCallback">
                                                <items>
												</items>
                                            </dxe:ASPxComboBox>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;">
                                            <dxe:ASPxComboBox ID="dxeddlBranchId" ClientInstanceName="dxeddlBranchId" runat="server"
                                                Width="240px" DropDownStyle="DropDownList" OnCallback="CarrierBranchIDCallback">
                                                <items>
												</items>
                                            </dxe:ASPxComboBox>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;">
                                            <dxe:ASPxDateEdit ID="dxeStartDate" ClientInstanceName="dxeStartDate" runat="server" Width="240px">
                                            </dxe:ASPxDateEdit>
                                        </td>
                                        ...
                                        <td style="text-align: left;">
                                            <dxe:ASPxDateEdit ID="dxeEndDate" ClientInstanceName="dxeEndDate" runat="server" Width="240px">
                                            </dxe:ASPxDateEdit>
                                        </td>
