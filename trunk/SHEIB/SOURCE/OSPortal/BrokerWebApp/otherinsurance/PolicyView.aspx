...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //判断此保单是否批改,如果不是批改,则因此批改项
        $(document).ready(function() {
            dxeIsAlterCallback.PerformCallback();
        });

        //

        function IsAlterCallbackComplete(s, e) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dxcb:ASPxCallback ID="dxeIsAlterCallback" ClientInstanceName="dxeIsAlterCallback"
        runat="server" OnCallback="dxeIsAlterCallback_Callback">
        <ClientSideEvents CallbackComplete="function(s, e) {IsAlterCallbackComplete(s,e);}" />
    </dxcb:ASPxCallback>
