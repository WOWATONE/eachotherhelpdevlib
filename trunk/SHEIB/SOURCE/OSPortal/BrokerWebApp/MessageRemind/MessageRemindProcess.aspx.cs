...
namespace BrokerWebApp.MessageRemind
{
    ...
    public partial class MessageRemindProcess : BasePage
    {
        ...
        {
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindProcess_Personal))
            {
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindProcess_Group))
            {
                dxeddlDeptID.Value = this.CurrentUser.DeptID;
                dxeddlDeptID.ClientEnabled = false;
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindProcess_All))
            {
        ...
        private void bindDropDownLists()
        {
            ...
            else if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindProcess_All))
            {
        ...
        private void BindGrid()
        {
            ...
            DataTable dt = BusinessObjects.BO_SysSet.MessageRemindProcess(lsWhere).Tables[0];
