<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" Theme="Aqua" CodeBehind="MessageRemindCustomerPtFollow.aspx.cs"
    Inherits="BrokerWebApp.MessageRemind.MessageRemindCustomerPtFollow" %>
                        ...
                        <tr>
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <TotalSummary>
                                        <dxwgv:ASPxSummaryItem FieldName="PolicyID" SummaryType="Count" ShowInColumn="CustomerName"
                                            DisplayFormat="保单数: {0}" />
                                    </TotalSummary>
