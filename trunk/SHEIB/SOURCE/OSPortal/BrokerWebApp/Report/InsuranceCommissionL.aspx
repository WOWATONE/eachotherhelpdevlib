<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" CodeBehind="InsuranceCommissionL.aspx.cs" Inherits="BrokerWebApp.Report.InsuranceCommissionL" %>
                            ...
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataColumn FieldName="Premium_New" Caption="新单保费金额(元)" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="Premium_ReNew" Caption="续保保费金额(元)" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="NeedPayinPremium" Caption="应付保费(元)" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="Process_New" Caption="新单经纪佣金(元)" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="Process_ReNew" Caption="续保经纪佣金(元)" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                    </Columns>
                                    <%-- EndRegion --%>
