<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" Theme="Aqua" CodeBehind="CustomerPtFollow.aspx.cs" Inherits="BrokerWebApp.CustomerRelation.CustomerPtFollow" %>
                ...
                <asp:Panel ID="npSearchDetail" runat="server" CssClass="allborderPanel">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <dxe:ASPxDateEdit ID="deStartFollowDate" ClientInstanceName="deStartFollowDate" runat="server"
                                    Width="160px">
                                </dxe:ASPxDateEdit>
                            </td>
                            ...
                            <td style="text-align: left;" colspan="2">
                                <dxe:ASPxDateEdit ID="deEndFollowDate" ClientInstanceName="deEndFollowDate" runat="server"
                                    Width="160px">
                                </dxe:ASPxDateEdit>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 170px; text-align: left;">
                                <dxe:ASPxComboBox ID="dexddlFollowType" ClientInstanceName="dexddlFollowType" runat="server"
                                    Width="160px" DropDownStyle="DropDownList">
                                    <Items>
            ...
            <td style="width: 100%;">
                ...
                <asp:Panel ID="npSearchResultDetail" runat="server" CssClass="collapsePanel">
                    <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                        KeyFieldName="FollowID" Width="100%" AutoGenerateColumns="False" Settings-ShowFooter="true"
                        SettingsPager-AlwaysShowPager="true">
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="跟进编号" FieldName="FollowID" CellStyle-Wrap="False"
                        ...
                        <GroupSummary>
                            <dxwgv:ASPxSummaryItem FieldName="FollowID" SummaryType="Count" ShowInGroupFooterColumn="FollowID"
                                DisplayFormat="总计: {0}" />
                        </GroupSummary>
                        <TotalSummary>
                            <dxwgv:ASPxSummaryItem FieldName="FollowID" SummaryType="Count" ShowInGroupFooterColumn="FollowID"
