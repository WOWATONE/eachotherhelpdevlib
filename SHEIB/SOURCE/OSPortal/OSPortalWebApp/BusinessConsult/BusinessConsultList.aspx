<%@ Page Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="BusinessConsultList.aspx.cs" Inherits="OSPortalWebApp.BusinessConsult.BusinessConsultList" Title="" %>
        ...
        <tr>
            <td style="height:40px; width:60%;">
                <dxm:ASPxMenu EnableViewState="False" EncodeHtml="False" id="dpASPxMenu" runat="server" AllowSelectItem="True" Orientation="Horizontal">
                    ...
                    <Items>
                        <dxm:MenuItem Text="新    建" Name="BusinessConsult.aspx"></dxm:MenuItem>
                    </Items>
                </dxm:ASPxMenu>
            </td>
        </tr>
                ...
                <asp:Panel ID="npSearchDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table>
                        <tr>
                            ...
                            <asp:TextBox ID="txtConsultNo" runat="server" Width="175px"></asp:TextBox></td>
                            <td style="width:70px; text-align:right;">
                            客户经理：</td>
                            <td style="width:180px; text-align:left;">
                        ...
                        <tr>
                            ...
                            至</td>
                            <td style="width:180px; text-align:left;">
                            <dxe:ASPxDateEdit ID="deEndDate" runat="server"></dxe:ASPxDateEdit></td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            ...
                            联系人：</td>
                            <td style="width:180px; text-align:left;">
                            <asp:TextBox ID="txtLinkMan" runat="server" Width="175px"></asp:TextBox></td>
                            <td style="width:70px; text-align:right;">
                            </td>
                       ...
                       <tr>
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server" 
                                                    KeyFieldName="ConsultNO" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="咨询号" FieldName="ConsultNO" 
                                            VisibleIndex="1">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="咨询日期" FieldName="ConsultDate" 
                                            VisibleIndex="2">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="客户经理" FieldName="Sales" VisibleIndex="3">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="客户" FieldName="CustName" 
                                            VisibleIndex="4">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="联系人" FieldName="LinkMan" 
                                            VisibleIndex="5">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="联系方式" FieldName="ContactType" 
                                            VisibleIndex="6">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="咨询费（总）" FieldName="TotalConsultFee" 
                                            VisibleIndex="7">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="发票号" FieldName="InvoiceNO" 
                                            VisibleIndex="8">
                                        </dxwgv:GridViewDataTextColumn>
