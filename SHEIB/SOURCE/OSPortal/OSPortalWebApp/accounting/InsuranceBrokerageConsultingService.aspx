<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="InsuranceBrokerageConsultingService.aspx.cs" Inherits="OSPortalWebApp.accounting.InsuranceBrokerageConsultingService" %>
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="Field1" Caption="再保险" CellStyle-Wrap="False">                                                                    
