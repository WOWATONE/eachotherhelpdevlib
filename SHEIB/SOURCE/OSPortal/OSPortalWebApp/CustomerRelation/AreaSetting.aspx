<%@ Page Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="AreaSetting.aspx.cs" Inherits="OSPortalWebApp.CustomerRelation.AreaSetting" Title="" %>
                    ...
                    <table style="width:100%">
                        <tr>
                            <td style="text-align:left;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnAddArea" runat="server" CssClass="input_2" Text="增加区域" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnEditArea" runat="server" Text="修改区域" CssClass="input_2" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnDeleteArea" runat="server" Text="删除区域" CssClass="input_2" />
                            </td>  
