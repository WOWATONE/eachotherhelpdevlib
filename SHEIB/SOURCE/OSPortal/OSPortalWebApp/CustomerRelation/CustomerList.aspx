<%@ Page Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="CustomerList.aspx.cs" Inherits="OSPortalWebApp.CustomerRelation.CustomerList" Title="" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register assembly="DevExpress.Web.ASPxGridView.v8.3" namespace="DevExpress.Web.ASPxGridView" tagprefix="dxwgv" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>保单录入列表</title>
    <script type="text/javascript">
        function menuClick(btnName) {
            if(btnName == "btnadd")
            {
                var myArguments="resizable:yes;scroll:yes;status:no;dialogWidth=1024px;dialogHeight=700px;center=yes;help=no";
        ...
        <tr>
            <td style="width:100%;">
                    ...
                    <table style="width:100%">
                        <tr>
                            <td style="text-align:left;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnadd" runat="server" CssClass="input_2" Text="添加" OnClientClick="javascript:menuClick('btnadd');" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Panel ID="npsearch" runat="server" CssClass="allborderPanel">
                    <table style="width:100%">
                        <tr>
                            <td style="width:33%;text-align:left;" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="radPerson"
