<%@ Page Language="C#" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true"
    Theme="Aqua" CodeBehind="NotifyClaim.aspx.cs" Inherits="OSPortalWebApp.CustomerClaim.NotifyClaim"
    Title="" %>
                ...
                <asp:Panel ID="npBaseInfoHeader" runat="server" CssClass="collapsePanelHeader" Height="25px">
                    <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                        <div style="float: left; vertical-align: middle;">
                            <asp:ImageButton ID="img_npBaseInfoHeader" runat="server" ImageUrl="~/images/expand_blue.jpg"
                                AlternateText="" />
                        </div>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                ...
                                <img runat="server" id="imgPolicyNoSearch" alt="" src="../images/searchicon9.png" style="width:20px; height:20px; vertical-align:top;" onclick="javascript:imgPolicyNoClick();" />   
                            </td>
                            <td style="width: 10%; text-align: right;">
                                保险公司：
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtCarrier" runat="server" Width="200px"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtBeneficiary" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                险种：
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtProdType" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtSales" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td style="width: 10%; text-align: right;">
                            </td>
                            <td style="width: 35%; text-align: left;">
                ...
                <asp:Panel ID="npNotifyInfoDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deNotifyTime" runat="server" />
                            </td>
                            <td style="width: 10%; text-align: right;">
                                出险地点：
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtAccidentSpot" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deAccidentTime" runat="server" />
                            </td>
                            <td style="width: 10%; text-align: right;">
                                损失性质：
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtNotifyLossFee" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deNotifyCarrierTime" runat="server" />
                            </td>
                            <td style="width: 10%; text-align: right;">
                                报案号：
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="dePerambulateTime" runat="server" />
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <asp:TextBox ID="txtSales2" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                制单日期:
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deCreateDate" runat="server" />
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
