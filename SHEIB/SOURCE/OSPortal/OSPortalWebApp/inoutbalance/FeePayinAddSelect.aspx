<%@ Page Title="解付保费选择" Language="C#" Theme="Aqua" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true" CodeBehind="FeePayinAddSelect.aspx.cs" Inherits="OSPortalWebApp.inoutbalance.FeePayinAddSelect" %>
                        ...
                        <td style="width:100%;" colspan="2"> 
                            ...
                            <asp:Panel ID="npSearchDetail" runat="server" CssClass="collapsePanel" Height="0">
                                ...
                                <table style="width:720px;">
                                                <tr>
                                                    <td style="width:80px;text-align:right;">通知书号：</td>
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataDateColumn FieldName="NoticeDate" Caption="收款日期" CellStyle-Wrap="False" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd">                                                                   
                                                                </dxwgv:GridViewDataDateColumn>
                                                                <dxwgv:GridViewDataColumn FieldName="Fee" Caption="已收保费" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>      
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="InvoiceState" Caption="状态" CellStyle-Wrap="False"/>  
                                                            </Columns>
                                                        <%-- EndRegion --%>
