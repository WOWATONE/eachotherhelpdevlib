<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="FeePayin.aspx.cs" Inherits="OSPortalWebApp.inoutbalance.FeePayin" %>
                                                    ...
                                                    >
                                                        <%-- BeginRegion Columns --%>
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="FeeAdjust" Caption="应付保费" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                
                                                                <dxwgv:GridViewDataColumn FieldName="FeeYJF" Caption="已解付保费" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                <dxwgv:GridViewDataColumn FieldName="FeeBCSF" Caption="本次实付保费" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                <dxwgv:GridViewDataColumn FieldName="FeeBCJF" Caption="本次解付保费" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                <dxwgv:GridViewDataColumn FieldName="ProcessSS" Caption="实收经纪费" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                
                                                                
                                                                <dxwgv:GridViewDataColumn FieldName="AccountType" Caption="收费方式" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                <dxwgv:GridViewDataColumn FieldName="SerialNo" Caption="单据流水号" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="SalesId" Caption="业务员编号" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                ...
                                                                <dxwgv:GridViewDataColumn FieldName="FeeNoticeID" Caption="代收保费通知书编号" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
                                                                <dxwgv:GridViewDataColumn FieldName="EnterAccountID" Caption="直付保费入账确认单编号" CellStyle-Wrap="False">                                                                   
                                                                </dxwgv:GridViewDataColumn>
