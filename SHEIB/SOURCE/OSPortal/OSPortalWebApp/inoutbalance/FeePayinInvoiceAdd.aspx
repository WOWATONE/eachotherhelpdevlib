<%@ Page Title="经纪费开票录入" Language="C#" Theme="Aqua" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true" CodeBehind="FeePayinInvoiceAdd.aspx.cs" Inherits="OSPortalWebApp.inoutbalance.FeePayinInvoiceAdd" %>
                             ...
                             >
                                ...
                                <Templates>
                                     ...
                                     <div style="padding:4px 4px 3px 4px">
                                        <table>
                                            <tr>
                                                <td style="white-space:nowrap; text-align:right;">开票金额:</td>
                ...
                <asp:Panel ID="npOtherPolicyItemDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <asp:TextBox ID="txtAdjust" runat="server" Width="100px"></asp:TextBox>
                            </td>
                            ...
                            <table style="width:100%">
                                <tr>
                                    ...
                                    <td style="width:140px;text-align:left;">
                                        <dxe:ASPxButton runat="server" ID="ASPxButton1" Text="打印开票通知书" AutoPostBack="false"></dxe:ASPxButton>
                                    </td>
                                    <td style="width:80px;text-align:left;">
                                        <dxe:ASPxButton runat="server" ID="ASPxButton4" Text="开票完成" AutoPostBack="false"></dxe:ASPxButton>
                                    </td>
                                    <td style="width:60px;text-align:left;">
