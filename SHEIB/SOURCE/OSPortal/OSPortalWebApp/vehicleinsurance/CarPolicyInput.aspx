<%@ Page Title="车险保单录入" Language="C#" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="CarPolicyInput.aspx.cs" Inherits="OSPortalWebApp.vehicleinsurance.CarPolicyInput" %>
                                        ...
                                        <table style="width:99%">
                                                                ...
                                                                <table style="width:100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width:15%;text-align:left;">
                                                                            <dxe:ASPxButton AutoPostBack="False" runat="server" ID="btnOriginalPolicySelect" Text="选择询价单" style="margin: 0px;">
                                                                                <ClientSideEvents Click="function(s, e) {return false;}" />
                                                                            </dxe:ASPxButton>
                                                                        </td>
                                                                        <td style="width:20%;text-align:left;">
                                                                            <dxe:ASPxButton AutoPostBack="False" runat="server" ID="btnOriginalPolicyDetail" Text="查看询价单" style="margin: 0px;">
                                                                                <ClientSideEvents Click="function(s, e) {return false;}" />
                                                                            </dxe:ASPxButton>
                                                                        </td>
                                                                        <td style="width:10%;text-align:right;">保费：</td>
                                                                        <td style="width:20%;text-align:left;">
                                                                            <asp:TextBox ID="txtFee" runat="server" Width="120px"></asp:TextBox>                                                                                                        
                                                                        </td>
                                            ...
                                            <td style="width:100%;">
                                                ...
                                                <asp:Panel ID="npCostSummaryDetail" runat="server" CssClass="collapsePanel" Height="0">
                                                            <table style="width:100%">
                                                                <tr>
                                                                    <td style="width:13%;text-align:right;">商业险保费：</td>
                                                                    <td style="width:20%;text-align:left;">
