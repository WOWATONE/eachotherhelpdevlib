<%@ Page Title="询价单审核" Language="C#" MasterPageFile="~/SiteMastePages/PopupMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="CarPolicyCheck.aspx.cs" Inherits="OSPortalWebApp.vehicleinsurance.AskPriceCheck" %>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            OnRowDeleted="gridPolicyItem_RowDeleted"
                                                                             >
                                                                                <%-- BeginRegion Columns --%>
                                                                                    <Columns>
                                                                                        <dxwgv:GridViewDataColumn Caption="&nbsp;" CellStyle-Wrap="False" CellStyle-HorizontalAlign="Left" Width="25" HeaderStyle-Wrap="False" Settings-AllowDragDrop="False">
                                                                                            <DataItemTemplate>
