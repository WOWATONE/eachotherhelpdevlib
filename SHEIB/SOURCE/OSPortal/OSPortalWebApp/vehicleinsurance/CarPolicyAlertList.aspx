<%@ Page Title="询价单批改列表" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
                            ...
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataColumn FieldName="PrePolicyNo" Caption="询价单号" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="PrePolicyNo" Caption="投保单号" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="PrePolicyNo" Caption="保单编号" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="PrePolicyNo" Caption="批改单号" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                        <dxwgv:GridViewDataColumn FieldName="PrePolicyNo" Caption="车牌号码" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
