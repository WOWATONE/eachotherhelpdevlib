<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/PopupUploadMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="NotifyClaimView.aspx.cs" Inherits="BrokerWebApp.CustomerClaim.NotifyClaimView" %>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxComboBox ID="dxeddlPolicyNo" ClientInstanceName="dxeddlPolicyNo" runat="server" Width="160px" DropDownStyle="DropDownList"></dxe:ASPxComboBox> 
                            </td>
                            <td style="width: 10%; text-align: right;">
                                保险公司：
                            </td>
                ...
                <asp:Panel ID="npNotifyInfoDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxComboBox ID="dxeddlNotifyType" ClientInstanceName="dxeddlNotifyType" runat="server" Width="160px" DropDownStyle="DropDownList"></dxe:ASPxComboBox>
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deNotifyTime" ClientInstanceName="deNotifyTime" runat="server" Width="160px"></dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                出险地点：
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deAccidentTime" ClientInstanceName="deAccidentTime" runat="server" Width="160px"></dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                损失性质：
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxComboBox ID="dxeddlLossType" ClientInstanceName="dxeddlLossType" runat="server" Width="160px" DropDownStyle="DropDownList"></dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 5%; text-align: right;">
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <input type="button" id="btn1" name="btn1" value="已报案" class="input_2"/>&nbsp;&nbsp;
                                <input type="button" id="btn2" name="btn2" value="资料不全" class="input_2"/>&nbsp;&nbsp;
                                <input type="button" id="btn3" name="btn3" value="资料已齐" class="input_2"/>&nbsp;&nbsp;
                                <input type="button" id="btn4" name="btn4" value="结案" class="input_2"/>
                            </td>
                            <td style="width: 10%; text-align: right;">
                            </td>
                            <td style="width: 35%; text-align: left;">
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deNotifyCarrierTime" ClientInstanceName="deNotifyCarrierTime" runat="server" Width="160px"></dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                报案号：
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxTextBox ID="dxetxtNotifyNo" ClientInstanceName="dxetxtNotifyNo" runat="server" Width="160px"></dxe:ASPxTextBox>
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxTextBox ID="dxetxtCreatePerson" ClientInstanceName="dxetxtCreatePerson" runat="server" Width="160px"></dxe:ASPxTextBox>
                            </td>
                            <td style="width: 10%; text-align: right;">
                                制单日期:
                            </td>
                            <td style="width: 35%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deCreateDate" ClientInstanceName="deCreateDate" runat="server" Width="160px"></dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 5%; text-align: left;">
                            </td>
                        </tr>
