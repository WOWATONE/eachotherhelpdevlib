<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/PopupUploadMaster.Master" AutoEventWireup="true" Theme="Aqua" CodeBehind="BusinessConsult.aspx.cs" Inherits="BrokerWebApp.BusinessConsult.BusinessConsult" %>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxTextBox ID="dxetxtConsultFeeNo" ClientInstanceName="dxetxtConsultFeeNo" runat="server" Width="160px">
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deConsultDate" ClientInstanceName="deConsultDate" runat="server" Width="160px">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithText" SetFocusOnError="True">
									    <RequiredField ErrorText="不能为空" IsRequired="True" />                                        
                                    </ValidationSettings>
                                </dxe:ASPxDateEdit>
            ...
            <td style="width: 100%;">
                ...
                <asp:Panel ID="npConsultFeeItemDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table style="width: 100%">
                            ...
                            <td>
                                <dxwgv:ASPxGridView ID="gridConsultFeeItem" ClientInstanceName="gridConsultFeeItem"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="咨询项目编号" FieldName="ConsultFeeItemID" CellStyle-Wrap="False" HeaderStyle-HorizontalAlign="Center">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="序号" FieldName="SerialNumber" CellStyle-Wrap="False" HeaderStyle-HorizontalAlign="Center">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="咨询项目" FieldName="ConsultFeeItem" CellStyle-Wrap="False" HeaderStyle-HorizontalAlign="Center">
                                        </dxwgv:GridViewDataTextColumn>
                                            ...
                                            <div style="padding: 4px 4px 3px 4px; text-align: center;">
                                                <table style="width: 70%;" runat="server" id="tblgridContactItemEditorTemplate">
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                            <dxe:ASPxTextBox ID="dxetxtConsultFeeItemID" ClientInstanceName="dxetxtConsultFeeItemID" runat="server" Text='<%# Eval("ConsultFeeItemID") %>'></dxe:ASPxTextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; text-align: right;">
                                                            序号：
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <dxe:ASPxTextBox ID="dxetxtSerialNumber" ClientInstanceName="dxetxtSerialNumber" runat="server" Text='<%# Eval("SerialNumber") %>'></dxe:ASPxTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="white-space: nowrap; text-align: right;">
                                                        ...
                                                        <td style="text-align: left;">
                                                            <dxe:ASPxTextBox ID="dxetxtConsultFeeItem" ClientInstanceName="dxetxtConsultFeeItem" runat="server" Text='<%# Eval("ConsultFeeItem") %>'></dxe:ASPxTextBox>
                                                        </td>
                                                        <td style="white-space: nowrap; text-align: right;">
                                                            咨询费：
                                                        </td>
                                                        <td style="text-align: left;">
                                                           <dxe:ASPxTextBox ID="dxetxtConsultFee" ClientInstanceName="dxetxtConsultFee" runat="server" Text='<%# Eval("ConsultFee") %>'></dxe:ASPxTextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                        ...
                        <tr>
                            <td>
                                发票号：<dxe:ASPxTextBox ID="dxetxtInvoiceNO" ClientInstanceName="dxetxtInvoiceNO" runat="server" Width="160px">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithText" SetFocusOnError="True">
									    <RequiredField ErrorText="不能为空" IsRequired="True" />                                        
                                    </ValidationSettings>
                                </dxe:ASPxTextBox>
                ...
                <asp:Panel ID="npCreateDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 25%; text-align: left;">
                                <dxe:ASPxDateEdit ID="deCreateTime" ClientInstanceName="deCreateTime" runat="server" Width="160px" Enabled="false">
                                </dxe:ASPxDateEdit>
                            </td>
                            <td style="width: 8%; text-align: right;">&nbsp;</td>
                            <td style="text-align: left;">&nbsp;</td>
