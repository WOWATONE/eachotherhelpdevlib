                             ...
                             >
                                <%-- BeginRegion Columns --%>
                                    ...
                                    <GroupSummary>
                                        ...
                                        <dxwgv:ASPxSummaryItem FieldName="PayinInvoiceedFee" ShowInGroupFooterColumn="PayinInvoiceedFee" SummaryType="Sum" />
                                        <dxwgv:ASPxSummaryItem FieldName="Fee" ShowInGroupFooterColumn="Fee" SummaryType="Sum"  DisplayFormat="{0:c}"/>
                                    </GroupSummary>
                                <%-- EndRegion --%>
        ...
        <tr>
            <td>
                ...
                <asp:Panel ID="npOtherPolicyItemDetail" runat="server" CssClass="collapsePanel" Height="0">
                    ...
                    <table style="width:100%">
                        <tr>
                            <td style="width:100;text-align:right;">经纪费收取方式：</td>
                            ...
                            <td style="width:130;text-align:left;"></td>
                            <td style="width:100;text-align:right;"></td>
                            <td style="width:130;text-align:left;"></td>                                  
                        </tr> 
                        <tr>
                            ...
                            <table style="width:100%">
                                <tr>
                                    ...
                                    <td style="width:140px;text-align:left;">
                                        <dxe:ASPxButton runat="server" ID="dxebtnPrint" ClientInstanceName="dxebtnPrint" Text="打印经纪费入账单" AutoPostBack="false"></dxe:ASPxButton>
                                    </td>
                                    <td style="width:80px;text-align:left;">
                                        <dxe:ASPxButton runat="server" ID="dxebtnComplete" ClientInstanceName="dxebtnComplete" Text="结算完成" AutoPostBack="false"></dxe:ASPxButton>
                                    </td>
                                    <td style="width:60px;text-align:left;">
