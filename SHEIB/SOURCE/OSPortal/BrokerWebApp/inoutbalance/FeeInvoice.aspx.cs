...
namespace BrokerWebApp.inoutbalance
{
    public partial class FeeInvoice : BasePage
    {
        ...
        private void BindGrid()
        {
            ...
            DataTable dt = Bo_FeeInvoice.GetFeeInvoiceList(lsWhere).Tables[0];
            ...
            DevExpress.Web.ASPxGridView.ASPxGridViewTableRowEventArgs e)
        {
            ...
            if (e.RowType == DevExpress.Web.ASPxGridView.GridViewRowType.Data)
            {
                ...
                if (!this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.FeeVoice_Delete))
                {
