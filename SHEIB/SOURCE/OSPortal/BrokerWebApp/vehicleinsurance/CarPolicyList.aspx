<%@ Page Title="车险保单查询" Language="C#" Theme="Aqua" MasterPageFile="~/SiteMastePages/ContentMaster.Master" AutoEventWireup="true" CodeBehind="CarPolicyList.aspx.cs" Inherits="BrokerWebApp.vehicleinsurance.CarPolicyList" %>
                                           ...
                                           <tr>
                                                <td>
                                                    ...
                                                    <asp:ObjectDataSource ID="ds_gridSearchResult" runat="server" 
                                                        ...
                                                        >
                                                        <SelectParameters> 
                                                             <asp:Parameter Name="sWhere" Type="String" Direction="Input" DefaultValue=" AND ISNULL(B.PolicyType,'0') ='1' " />
                                                        </SelectParameters>
