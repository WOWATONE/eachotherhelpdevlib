<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" Theme="Aqua" CodeBehind="RptStatisticByCarrier.aspx.cs"
    Inherits="BrokerWebApp.Report.RptStatisticByCarrier" %>
            ...
            <td style="width: 100%;">
                ...
                <asp:Panel ID="npSearchResultDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="保险公司" FieldName="CarrierName" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="分支机构" FieldName="BranchName" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center" >
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="本月保费" FieldName="Premium" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="累计保费" FieldName="PremiumSum" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="本月经纪费" FieldName="Process" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="累计经纪费" FieldName="ProcessSum" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center">
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
                        <GroupSummary>
                            <dxwgv:ASPxSummaryItem FieldName="Premium" SummaryType="Sum" ShowInGroupFooterColumn="Premium"
                                DisplayFormat=" {0}" />
                            <dxwgv:ASPxSummaryItem FieldName="PremiumSum" SummaryType="Sum" ShowInGroupFooterColumn="PremiumSum"
                                DisplayFormat=" {0}" />
                            <dxwgv:ASPxSummaryItem FieldName="Process" SummaryType="Sum" ShowInGroupFooterColumn="Process"
                                DisplayFormat=" {0}" />
