<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" Theme="Aqua" CodeBehind="RptStatisticByCustomer.aspx.cs"
    Inherits="BrokerWebApp.Report.RptStatisticByCustomer" %>
            ...
            <td style="width: 100%;">
                ...
                <asp:Panel ID="npSearchResultDetail" runat="server" CssClass="collapsePanel" Height="0">
                    <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="客户分类" FieldName="CustClassifyName" CellStyle-Wrap="False"
                                HeaderStyle-HorizontalAlign="Center" GroupIndex="0">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="客户名称" FieldName="CustomerName" CellStyle-Wrap="False"
