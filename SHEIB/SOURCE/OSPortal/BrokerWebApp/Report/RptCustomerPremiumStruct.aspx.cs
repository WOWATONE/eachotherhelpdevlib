...
{
    public partial class RptCustomerPremiumStruct : BasePage
    {
        ...
        protected void btnXlsExport_Click(object sender, EventArgs e)
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", disposition + "; filename=" + "RptCustomerPremiumStruct.xls");
        ...
        private void BindGrid()
        {
            ...
            DataTable dt = BusinessObjects.BO_Report.RptCustomerPremiumStruct(lsStartDate, lsEndDate).Tables[0];
