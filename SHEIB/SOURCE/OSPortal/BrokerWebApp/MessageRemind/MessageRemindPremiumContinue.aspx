<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMastePages/ContentMaster.Master"
    AutoEventWireup="true" Theme="Aqua" CodeBehind="MessageRemindPremiumContinue.aspx.cs"
    Inherits="BrokerWebApp.MessageRemind.MessageRemindPremiumContinue" %>
                            ...
                            <td>
                                <dxwgv:ASPxGridView ID="gridSearchResult" ClientInstanceName="gridSearchResult" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataColumn FieldName="OutDay" Caption="天数" CellStyle-Wrap="False">
                                        </dxwgv:GridViewDataColumn>
                                    </Columns>
                                    <%-- EndRegion --%>
