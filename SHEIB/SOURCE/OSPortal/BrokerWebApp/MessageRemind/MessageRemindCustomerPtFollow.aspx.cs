...
namespace BrokerWebApp.MessageRemind
{
    ...
    public partial class MessageRemindCustomerPtFollow : BasePage
    {
        ...
        {
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindCustomerPtFollow_Personal))
            {
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindCustomerPtFollow_Group))
            {
                dxeddlDeptID.Value = this.CurrentUser.DeptID;
                dxeddlDeptID.ClientEnabled = false;
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindCustomerPtFollow_All))
            {
        ...
        private void bindDropDownLists()
        {
            ...
            else if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindCustomerPtFollow_All))
            {
        ...
        private void BindGrid()
        {
            ...
            DataTable dt = BusinessObjects.BO_SysSet.MessageRemindCustomerPtFollow(lsWhere).Tables[0];
