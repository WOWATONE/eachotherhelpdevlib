...
namespace BrokerWebApp.MessageRemind
{
    ...
    public partial class MessageRemindPremiumContinue : BasePage
    {
        ...
        {
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPremiumContinue_Personal))
            {
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPremiumContinue_Group))
            {
                dxeddlDeptID.Value = this.CurrentUser.DeptID;
                dxeddlDeptID.ClientEnabled = false;
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPremiumContinue_All))
            {
        ...
        private void bindDropDownLists()
        {
            ...
            else if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPremiumContinue_All))
            {
        ...
        private void BindGrid()
        {
            ...
            DataTable dt = BusinessObjects.BO_SysSet.MessageRemindPremiumContinue(lsWhere).Tables[0];
