...
namespace BrokerWebApp.MessageRemind
{
    ...
    public partial class MessageRemindPayInOut : BasePage
    {
        ...
        {
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPayInOut_Personal))
            {
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPayInOut_Group))
            {
                dxeddlDeptID.Value = this.CurrentUser.DeptID;
                dxeddlDeptID.ClientEnabled = false;
            ...
            if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPayInOut_All))
            {
        ...
        private void bindDropDownLists()
        {
            ...
            else if (this.CurrentUser.CheckPermission(BusinessObjects.BO_P_Priv.PrivListEnum.MessageRemindPayInOut_All))
            {
        ...
        private void BindGrid()
        {
            ...
            DataTable dt = BusinessObjects.BO_SysSet.MessageRemindPayInOut(lsWhere).Tables[0];
