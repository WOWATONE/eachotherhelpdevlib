...
namespace BusinessObjects
{
    ...
    public class BO_P_Customer : BaseObject
    {
        ...
        public BO_P_Customer(String id)
        {
            //fetchByID(id);
        }
        ...
        public static List<BO_P_Customer> FetchList()
        {
            List<BO_P_Customer> list = new List<BO_P_Customer>();
            ...
            BO_P_Customer newObj;
            using (IDataReader reader = _db.ExecuteReader(dbCommand))
            {
                while (reader.Read())
                {
                    newObj = new BO_P_Customer();
