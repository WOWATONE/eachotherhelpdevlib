...
namespace BusinessObjects
{
    ...
    public class BO_Customer : BaseObject
    {
        ...
        public static DataTable GetCustomerList(string sWhere)
        {
            ...
            sb.Append("Select C.CustID, (Select CustClassifyName from CustClassify where CustClassifyID=C.CustClassifyID) As CustTypeName, C.CustName, CO1.CodeName As AreaName, D.DeptName As DeprtmentName, C.Address,");
